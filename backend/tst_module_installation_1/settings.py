"""
Django settings for tst_module_installation_1 project.
...
ROOT_URLCONF = 'tst_module_installation_1.urls'
...
WSGI_APPLICATION = 'tst_module_installation_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Tst Module Installation Support <support@tst-module-installation-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_module_installation_1 API",
    "DESCRIPTION": "API documentation for tst_module_installation_1 App",
    "VERSION": "v1",
}
